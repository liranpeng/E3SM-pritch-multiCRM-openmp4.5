...
subroutine crm_history_register()
   ...
   call add_hist_coord('crm_nx2',    crm_nx,     'CRM NX2')
   call add_hist_coord('crm_ny2',    crm_ny,     'CRM NY2')
   call add_hist_coord('crm_nz2',    crm_nz,     'CRM NZ2')
...
subroutine crm_history_init(species_class)
   ...
   call addfld('SPWW2   ', (/'lev'/), 'A','m2/s2', 'w'w'^2')
   call addfld('SPBUOYA2', (/'lev'/), 'A','K/s', 'resolved buoyancy flux')
   call addfld('SPWW    ', (/'lev'/), 'A','m2/s2', 'w'w'^2')
