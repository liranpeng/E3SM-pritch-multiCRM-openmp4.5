...
set job_name       = smoketest_v0_hflag_1steps_openmp_${machine}_${resolution}_CRM1_${crm_nx}x_${crm_nz}z${crm_dx}m.${crm_dt}s_crm_nx_rad_${crm_nx_rad}_CRM2_${crm_nx2}x_${crm_nz2}z${crm_dx2}m.${crm_dt2}s_crm_nx_rad2_${crm_nx_rad2}_np_${np}_nlev_${nlev}_nthread_${OMP_NUM_THREADS}
...
set e3sm_simulations_dir        = /scratch/07088/tg863871
...
cat <<EOF >> user_nl_cam
 ...
 fincl2 = 'FLUT','PRECT','U200','V200','U850','V850','Z500','OMEGA500','UBOT','VBOT','TREFHT','TREFHTMN','TREFHTMX','QREFHT','TS','PS','TMQ','TUQ','TVQ','SPWW','SPWW2','SPBUOYA2','SPBUOYA','TIMINGO','WWQUI_CEN','WWQUI_CLD_CEN','WWQUI_BND','WWQUI_CLD_BND'
