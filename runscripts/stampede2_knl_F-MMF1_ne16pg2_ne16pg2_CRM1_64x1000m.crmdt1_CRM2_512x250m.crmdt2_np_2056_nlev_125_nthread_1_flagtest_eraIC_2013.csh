...
set job_name       = smoketest_ERA5_IC_2013_hflag_1steps_openmp_${machine}_${resolution}_CRM1_${crm_nx}x_${crm_nz}z${crm_dx}m.${crm_dt}s_crm_nx_rad_${crm_nx_rad}_CRM2_${crm_nx2}x_${crm_nz2}z${crm_dx2}m.${crm_dt2}s_crm_nx_rad2_${crm_nx_rad2}_np_${np}_nlev_${nlev}_nthread_${OMP_NUM_THREADS}
...
cat <<EOF >> user_nl_cam
 ...
 ncdata         = '/scratch/07088/tg863871/inputdata/HICCUP_data_from_walter/HICCUP.atm_era5.2013-10-01.ne16np4.L125.nc'
